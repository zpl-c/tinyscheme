    ...
    _OP_DEF(opexe_2, "make-block",                     1,  2,       TST_NATURAL TST_INTEGER,            OP_MKBLOCK          )
    _OP_DEF(opexe_2, "block-length",                   1,  1,       TST_MEMBLOCK,                    OP_BLOCKLEN         )
    _OP_DEF(opexe_2, "block-ref",                      2,  2,       TST_MEMBLOCK TST_NATURAL,        OP_BLOCKREF         )
    _OP_DEF(opexe_2, "block-set!",                     1,  1,       TST_MEMBLOCK TST_NATURAL TST_CHAR, OP_BLOCKSET         )
